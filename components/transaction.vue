<template>
  <div v-if="transactions" class="container  min-w-full">
...
export default {
  ...
  data () {
    return {
      fields: ['TrxID', 'Amount', 'Units', 'Transaction Type', 'Transaction Date', 'Recorded at', 'Updated at'],
      menu: false
    }
  }
